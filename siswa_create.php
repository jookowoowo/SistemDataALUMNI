...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_message)) {
        ...
        $sql = "INSERT INTO siswa (id_admin, id_jurusan, nama, jenis_kelamin, email, kelas, alamat, foto, password) 
                VALUES ('$id_admin', '$id_jurusan', '$nama', '$jenis_kelamin', '$email', '$kelas', '$alamat', '$foto', '$hashed_password')";
        
        if (mysqli_query($conn, $sql)) {
            // Redirect setelah sukses menambah siswa
            header("Location: alumni_list.php?status=success_add_siswa");
            exit(); 
        } else {
...
<div class="container mx-auto p-4 mt-8">
    <h2 class="text-3xl font-bold text-gray-900 mb-6 text-center">Tambah Siswa Baru</h2>
    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        <form action="siswa_create.php" method="POST" enctype="multipart/form-data">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="kelas" id="kelas" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required value="<?php echo isset($_POST['kelas']) ? htmlspecialchars($_POST['kelas']) : ''; ?>">
            </div>
            <div class="mb-4">
